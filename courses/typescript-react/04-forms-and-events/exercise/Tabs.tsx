...
interface TabListProps extends React.ComponentPropsWithRef<'div'> {}
...
export const Tab = React.forwardRef<HTMLButtonElement, TabProps>(
  ({ children, onClick, onKeyDown, disabled, ...props }, forwardedRef) => {
    ...
    // Combine Refs
    const ref = useComposedRefs(tabRef, forwardedRef)
    ...
    function selectNextTab() {
      if (selectedIndex != null && selectedIndex < totalTabs - 1) {
        setSelectedIndex(selectedIndex + 1)
      }
    }
