...
export const Task = () => {
  ...
  function handleSetMinutes(newestMinutes) {
    // conditional stuff here
    setMinutes(newestMinutes)
  }
  ...
  return (
    <div className="spacing">
      <div className="spacing-small">
        ...
        <Minutes minutes={minutes} setMinutes={handleSetMinutes} min={completedMinutes} />
      </div>
      ...
      <div>
        <button disabled={minutes === 0} className={`button`}>
          Complete
        </button>
      </div>
    </div>
